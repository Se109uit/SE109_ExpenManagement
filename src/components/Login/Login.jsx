        ...
        <div className=''>
            <div className='container col-12 col-md-4 col-lg-4'>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="password" placeholder="Mật khẩu" className='py-2'/>

                    <Form.Text>
                    <div className='mt-2 d-flex justify-content-end'>
                        <a href="/forgot-password" className='some-purple-text text-decoration-none'>Quên mật khẩu?</a>
                    </div>
                    </Form.Text>
                </Form.Group>
                ...
                <div className='d-flex justify-content-between'>
                    <div className='d-grid gap-2 mt-4'>
                        <button type="button" className="button-login-google border shadow d-flex align-items-center justify-content-center">
                            <img className='' 
                    ...
                    {/* Login with Facebook */}
                    <div className='d-grid gap-2 mt-4'>
                        <button type="button" className="button-login-facebook border shadow d-flex align-items-center justify-content-center">
                ...
                <div>
                    <div className='d-flex justify-content-center mt-4'>
                        ...
                        <a href="/signup" className='fa-gg some-purple-text text-decoration-none'> Đăng ký ngay</a>
                    </div>
                </div>
            </div>
        </div>
